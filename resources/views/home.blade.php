                        ...
                        <div class="col-md-3 mb-4">
                            <div class="card h-100 shadow-sm border-primary">
                                <div class="card-body">
                                    ...
                                    <p class="card-text small">Gérer l'inventaire des boissons de la cave.</p>
                        ...
                        <div class="col-md-3 mb-4">
                            <div class="card h-100 shadow-sm border-warning">
                                <div class="card-body">
                                    ...
                                    <p class="card-text small">Gérer les accès des clients et administrateurs.</p>
                        ...
                        <div class="col-md-3 mb-4">
                            <div class="card h-100 shadow-sm border-info">
                                <div class="card-body">
                                    ...
                                    <p class="card-text small">Modifier vos infos personnelles et mot de passe.</p>
